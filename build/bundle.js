...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Task = __webpack_require__(/*! ./tasks/Task1 */ 159);
	
	var _Task2 = _interopRequireDefault(_Task);
	
	var _Task3 = __webpack_require__(/*! ./tasks/Task2 */ 166);
	...
	*/
	...
	__webpack_require__(/*! ./mock_api.js */ 170);
	__webpack_require__(/*! ./task_1_validator.js */ 171);
	__webpack_require__(/*! ./task_2_validator.js */ 172);
	 ...
	 ******************************************************************************/
		...
		var taskOne = function taskOne() {
			...
			_reactDom2.default.render(_react2.default.createElement(_Task2.default, { data: guestListData }), document.getElementById('task-one'));
		};
	 ...
	 ******************************************************************************/
		...
		var taskTwo = function taskTwo() {
			_reactDom2.default.render(_react2.default.createElement(_Task4.default, null), document.getElementById('task-two'));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventAttendeeList = __webpack_require__(/*! ../components/EventAttendeeList */ 160);
	
	var _EventAttendeeList2 = _interopRequireDefault(_EventAttendeeList);
	
	var _DataCapture = __webpack_require__(/*! ../components/DataCapture */ 161);
	
	var _DataCapture2 = _interopRequireDefault(_DataCapture);
	
	var _MailDispatch = __webpack_require__(/*! ../components/MailDispatch */ 162);
	
	var _MailDispatch2 = _interopRequireDefault(_MailDispatch);
	
	var _Thanks = __webpack_require__(/*! ../components/Thanks */ 163);
	
	var _Thanks2 = _interopRequireDefault(_Thanks);
	
	var _Save = __webpack_require__(/*! ../components/Save */ 164);
	
	var _Save2 = _interopRequireDefault(_Save);
	
	var _Reset = __webpack_require__(/*! ../components/Reset */ 165);
	...
	*/
	...
	var Task1 = function (_React$Component) {
	  ...
	  function Task1(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Task1).call(this, props));
	
	    _this.handleNameSelection = _this.handleNameSelection.bind(_this);
	    _this.handleDataSubmit = _this.handleDataSubmit.bind(_this);
	    _this.handleFlush = _this.handleFlush.bind(_this);
	    _this.next_step = _this.next_step.bind(_this);
	    _this.state = {
	      step: 'A',
	      name: '',
	      customerID: '',
	  ...
	  _createClass(Task1, [{
	    ...
	    key: 'handleNameSelection',
	    value: function handleNameSelection(n) {
	      this.setState({
	        name: n.name,
	    ...
	    value: function handleDataSubmit() {
	      // this.setState({
	      //   email: '',
	      //   postcode: '',
	      //   optedIn: false
	    ...
	    key: 'currentStepView',
	    value: function currentStepView() {
	      switch (this.state.step) {
	        case 'A':
	          return _react2.default.createElement(_EventAttendeeList2.default, { data: this.props.data, onNameSelection: this.handleNameSelection });
	          break;
	        case 'B':
	          return _react2.default.createElement(_DataCapture2.default, { data: this.state, onDataSubmit: this.handleDataSubmit });
	          break;
	        case 'C':
	          return _react2.default.createElement(_DataCapture2.default, { data: this.state, onDataSubmit: this.handleDataSubmit });
	          break;
	        case 'D':
	          return _react2.default.createElement(_MailDispatch2.default, { data: this.state, onNextStep: this.next_step });
	          break;
	        case 'E':
	          return _react2.default.createElement(_Thanks2.default, { data: this.state, onDone: this.next_step });
	          break;
	        case 'X':
	          return _react2.default.createElement(_Save2.default, { data: this.state, onNextStep: this.next_step });
	          break;
	        case 'F':
	          return _react2.default.createElement(_Reset2.default, { data: this.state, onFlush: this.handleFlush });
	          break;
	      }
	    }
	  }, {
...
/* 160 */
/*!*********************************************!*\
  !*** ./app/components/EventAttendeeList.js ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var EventAttendeeList = function (_React$Component) {
	  _inherits(EventAttendeeList, _React$Component);
	
	  function EventAttendeeList(props) {
	    _classCallCheck(this, EventAttendeeList);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EventAttendeeList).call(this, props));
	
	    _this._handleNameSelection = _this._handleNameSelection.bind(_this);
	    return _this;
	  }
	
	  _createClass(EventAttendeeList, [{
	    key: "_handleNameSelection",
	    value: function _handleNameSelection(e) {
	    ...
	    value: function render() {
	      ...
	      var AttendeeNodes = this.props.data.map(function (attendees) {
	        return _react2.default.createElement(
	          "div",
	          { className: "exampleGuestListView" },
	          _react2.default.createElement(Attendee, { data: attendees, onNameSelection: _this2._handleNameSelection })
	        );
	      });
	      return _react2.default.createElement(
	        "div",
	...
	exports.default = EventAttendeeList;
	
	var Attendee = function (_React$Component2) {
	  _inherits(Attendee, _React$Component2);
	
	  function Attendee(props) {
	    _classCallCheck(this, Attendee);
	
	    var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(Attendee).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataCapture = function (_React$Component) {
	  _inherits(DataCapture, _React$Component);
	
	  function DataCapture(props) {
	    _classCallCheck(this, DataCapture);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DataCapture).call(this, props));
	
	    _this._handleClick = _this._handleClick.bind(_this);
	    _this._handlePrize1 = _this._handlePrize1.bind(_this);
	    _this._handlePrize2 = _this._handlePrize2.bind(_this);
	    _this.state = {
	      step: 'A',
	      name: '',
	      customerID: '',
	  ...
	  _createClass(DataCapture, [{
	    key: '_handlePrize1',
	    value: function _handlePrize1() {
	      this.setState({
	        prize: 'prize 1'
	      });
	    }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            'email ? ',
	            _react2.default.createElement('input', { name: 'email', placeholder: 'e.g. your email', type: 'text' })
	          ),
	          _react2.default.createElement(
	            'div',
	            null,
	            'postcode ? ',
	            _react2.default.createElement('input', { name: 'postcode', placeholder: 'e.g. your postcode', type: 'text' })
	          ),
	          _react2.default.createElement(
	            'div',
	            null,
	            'name ? ',
	            _react2.default.createElement('input', { name: 'optedIn', placeholder: 'e.g. your name', type: 'checkbox' })
	          ),
	          _react2.default.createElement(
	            'div',
	            null,
	          ...
	          _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement('input', { name: 'name', value: '', placeholder: 'e.g. your name', type: 'text' })
	          ),
	          _react2.default.createElement(
	            'div',
	            null,
	...
	exports.default = DataCapture;

/***/ },
/* 162 */
/*!****************************************!*\
  !*** ./app/components/MailDispatch.js ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var MailDispatch = function (_React$Component) {
	  _inherits(MailDispatch, _React$Component);
	
	  function MailDispatch(props) {
	    _classCallCheck(this, MailDispatch);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(MailDispatch).call(this, props));
	  }
	
	  _createClass(MailDispatch, [{
	    key: "componentDidMount",
	    value: function componentDidMount() {
	      if (this.props.data.optedIn) MockAPI.sendEmail(this.props.data.email, 'registrationEmail', this.props.data, this.props.onNextStep());else this.props.onNextStep();
	    }
	  }, {
	    key: "render",
	    value: function render() {
	...
	exports.default = MailDispatch;

/***/ },
/* 163 */
/*!**********************************!*\
  !*** ./app/components/Thanks.js ***!
  \**********************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Thanks = function (_React$Component) {
	  ...
	  function Thanks(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Thanks).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Save = function (_React$Component) {
	  ...
	  function Save(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Save).call(this, props));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reset = function (_React$Component) {
	  ...
	  function Reset(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Reset).call(this, props));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Branding = __webpack_require__(/*! ../components/Branding */ 167);
	...
	var _InstantWinner = __webpack_require__(/*! ../components/InstantWinner */ 168);
	
	var _InstantWinner2 = _interopRequireDefault(_InstantWinner);
	
	var _Conditional = __webpack_require__(/*! ../components/Conditional */ 169);
	...
	*/
	...
	var Task2 = function (_React$Component) {
	  ...
	  function Task2(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Task2).call(this, props));
	  ...
	  _createClass(Task2, [{
	    ...
	    value: function next_step() {
	      switch (this.state.step) {
	        ...
	        case 'C':
	          ...
	          break;
	        case 'D':
	          if (this.state.winner) this.setState({ step: 'E' });else this.setState({ step: 'I' });
	          break;
	        case 'E':
	          this.setState({ step: 'F' });
	          break;
	    ...
	    value: function currentStepView() {
	      switch (this.state.step) {
	        case 'A':
	          return _react2.default.createElement(_Branding2.default, { onClick: this.next_step });
	          break;
	        case 'B':
	          return _react2.default.createElement(_DataCapture2.default, { data: this.state, onDataSubmit: this.handleDataSubmit });
	          break;
	        case 'C':
	          return _react2.default.createElement(_InstantWinner2.default, { onNextStep: this.next_step });
	          break;
	        case 'D':
	          return _react2.default.createElement(_Conditional2.default, { onNextStep: this.next_step });
	          break;
	        case 'E':
	          return _react2.default.createElement(_DataCapture2.default, { data: this.state, onDataSubmit: this.handleDataSubmit });
	          break;
...
/* 168 */
/*!*****************************************!*\
  !*** ./app/components/InstantWinner.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var InstantWinner = function (_React$Component) {
	  _inherits(InstantWinner, _React$Component);
	
	  function InstantWinner(props) {
	    _classCallCheck(this, InstantWinner);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(InstantWinner).call(this, props));
	  }
	
	  _createClass(InstantWinner, [{
	    key: "componentDidMount",
	    value: function componentDidMount() {
	      this.props.onNextStep();
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Conditional = function (_React$Component) {
	  ...
	  function Conditional(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Conditional).call(this, props));
	  }
...
/***/ function(module, exports) {
	...
	(function (window) {
		...
		function sendEmail(toAddress, templateName, templateVars, cb) {
			...
			setTimeout(function () {
				var templates = {
					'registrationEmail': function registrationEmail(templateVars) {
						return ['Hello ' + templateVars.name + ',', 'Thanks for signing up for our mailing list with the email address: ' + toAddress].join('\n');
					},
					'voucherCodeEmail': function voucherCodeEmail(templateVars) {
						return ['Hello ' + templateVars.name + ',', 'Congratulations, you have one our great prize!', 'To claim it please give this code to one of our staff members: ' + templateVars.voucherCode].join('\n');
					}
				};
		...
		window.MockAPI = {};
		window.MockAPI.sendEmail = sendEmail;
		window.MockAPI.generateVoucherCode = generateVoucherCode;
	})(window);

/***/ },
/* 171 */
/*!*********************************!*\
  !*** ./app/task_1_validator.js ***!
  \*********************************/
/***/ function(module, exports) {
	...
	(function (window) {
		...
		function validate(componentID, data) {
			var assertEquals = function assertEquals(predicate, message) {
				if (!predicate) {
					throw new Error(message);
				}
			};
